...
$arr2 = new ArrayClass();
$arr2->addLastElement(new ArrayStudent("Tom", 80));
$arr2->addLastElement(new ArrayStudent("Jack", 90));
$arr2->addLastElement(new ArrayStudent("Lili", 85));
echo $arr2. PHP_EOL;
